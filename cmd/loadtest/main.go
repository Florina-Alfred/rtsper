...
// Simple load tester that uses the local ffmpeg binary to publish and
// subscribe to many topics concurrently. It expects a sample file at
// docs/test_footage.mp4 by default and will create publishers that
// stream that file (looped) to rtsp publish endpoints and subscribers
// that pull from the subscribe endpoints and discard the received data.
